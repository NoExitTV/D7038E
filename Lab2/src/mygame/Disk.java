...
public abstract class Disk {
    ...
    public void moveAfterCollision(Disk otherDisk, float tpf) {
        while(this.checkCollisionWith(otherDisk)){
            this.diskNode.move(this.getSpeed().getX()*tpf, this.getSpeed().getY()*tpf, 0);
            otherDisk.diskNode.move(otherDisk.getSpeed().getX()*tpf, otherDisk.getSpeed().getY()*tpf, 0);
        }
